...
var _default = {
  ...
  methods: {
    ...
    loginHandler: function loginHandler() {
      ...
      _axios.default.post('/login', userData).then(function (res) {
        console.log(res);
        ...
        if (res.data.status) {
          ...
          _this.flashMessage = res.data.message;
        }
      }).catch(function (err) {
...
var _validation = _interopRequireDefault(__webpack_require__(49));

var _featureListItem = _interopRequireDefault(__webpack_require__(50));

var _schemaAside = _interopRequireDefault(__webpack_require__(55));

var _loadingIndicator = _interopRequireDefault(__webpack_require__(67));

var _flashMessage = _interopRequireDefault(__webpack_require__(71));
...
var _default = {
  components: {
    'feature': _featureListItem.default,
    'aside-search': _schemaAside.default,
  ...
  mounted: function mounted() {
    var swappableNnz = new _draggable.Swappable(document.querySelectorAll('.schema-create-features-nnz'), {
      draggable: '.feature-item',
      delay: 500
    });
    var swappableSite = new _draggable.Swappable(document.querySelectorAll('.schema-create-features-site'), {
      draggable: '.feature-item',
      delay: 500
  ...
  methods: {
      ...
      if (_validation.default.checkArticle(this.article)) {
        ...
        _axios.default.get("/getschema?source=".concat(this.source, "&id=").concat(this.article)).then(function (res) {
          if (res.data.success) {
            ...
            _this2.this.nnzFeaturesLastId = _this2.nnzFeatures.length;
          } else {
            _this2.stage = 1;

            _this2.showFlashMessage(res.data.data);
          }
        }).catch(function (err) {
          return console.log(err);
        });
      } else {
        var msg = "Поле артикул должно быть заполнено. Допускаются только цифры, длинна значения не менее 5 символов";
        this.showFlashMessage(msg);
      }
    },
    //Добавляем свойство
    addFeatureHandler: function addFeatureHandler() {
    ...
    //Удаляем свойство
    deleteFeatureHandler: function deleteFeatureHandler(id) {
      this.nnzFeatures = this.nnzFeatures.filter(function (v) {
        return v.id !== id;
      });
    },
    ...
    saveSchemaHandler: function saveSchemaHandler() {
      ...
      if (this.title.length > 0) {
        var token = localStorage.getItem('_token');
        var nnzFeatures = document.querySelectorAll('.schema-create-features-nnz .feature-item input');
        var siteFeatures = document.querySelectorAll('.schema-create-features-site .feature-item input');
        var regExpArr = Array.prototype.slice.call(siteFeatures, 0, nnzFeatures.length);
        var schema = {
          name: this.title,
          pattern: {}
        };

        for (var i = 0; i < nnzFeatures.length; i++) {
...
//
var _default = {
  props: ['iseditable', 'description', 'featureid', 'edit'],
  data: function data() {
    return {
      isEditable: this.iseditable,
      name: this.description,
      featureId: this.featureid,
      currentEdit: this.edit
    };
  },
  methods: {
    //Удаляем запись
    deleteHandler: function deleteHandler() {
      this.$emit('delete-feature', this.featureId);
    }
  }
};
exports.default = _default;
...
var _schemaAsideItem = _interopRequireDefault(__webpack_require__(59));
...
var _default = {
  ...
  computed: {
    ...
    //Показываем сообщение, если в компонент посупил текс
    flashMessage: function flashMessage() {
      return {
        'flashMessage': true,
        'flashMessage_inactive': this.text.length === 0,
        'flashMessage_active': this.text.length > 0
      };
    }
  }
};
...
var _variables = _interopRequireDefault(__webpack_require__(18));

var _normalize = _interopRequireDefault(__webpack_require__(21));

var _style = _interopRequireDefault(__webpack_require__(23));

var _vue = _interopRequireDefault(__webpack_require__(25));

var _vueRouter = _interopRequireDefault(__webpack_require__(28));

var _auth = _interopRequireDefault(__webpack_require__(29));

var _axios = _interopRequireDefault(__webpack_require__(3));

var _sideMenu = _interopRequireDefault(__webpack_require__(30));

var _sales = _interopRequireDefault(__webpack_require__(35));

var _login = _interopRequireDefault(__webpack_require__(39));

var _schema = _interopRequireDefault(__webpack_require__(44));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_side_menu_vue__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d1896c56_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_side_menu_vue__ = __webpack_require__(34);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_sales_vue__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8a6b8968_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sales_vue__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_59496b29_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
module.exports = "img/../img/background.jpg";
            ...
            directives: [
              {
                name: "show",
                rawName: "v-show",
                value: _vm.flashMsg.length > 0,
                expression: "flashMsg.length > 0"
              }
            ]
          },
          [_vm._v(_vm._s(_vm.flashMsg))]
        )
      ]
    )
  ])
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ff23f11_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_vue__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ff23f11_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ff23f11_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/vue-comp/schema.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1ff23f11", Component.options)
  } else {
    hotAPI.reload("data-v-1ff23f11", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("8c4de024", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1ff23f11\",\"scoped\":false,\"sourceMap\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1ff23f11\",\"scoped\":false,\"sourceMap\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
module.exports = "img/../img/plus.svg";
...
var _default = {
  ...
  checkArticle: function checkArticle(art) {
    var pattern = /\d{5,}/i;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_001c1d35_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_feature_list_item_vue__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_feature_list_item_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_001c1d35_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_feature_list_item_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_001c1d35_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_feature_list_item_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/vue-comp/interface/feature-list-item.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-001c1d35", Component.options)
  } else {
    hotAPI.reload("data-v-001c1d35", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("5a3fcd38", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-001c1d35\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./feature-list-item.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-001c1d35\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./feature-list-item.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n:root{font-family:Open Sans,sans-serif\n}\n.feature-item{display:flex;justify-content:space-between;margin:20px auto;width:90%;min-height:50px;box-shadow:1px 4px 6px rgba(0,143,159,.4);padding:10px\n}\n.draggable-mirror.feature-item{max-width:400px;box-shadow:0 0 6px rgba(0,143,159,.8)\n}\n.feature-item__name{width:70%;border:none;background-color:hsla(0,0%,100%,0)\n}\n.feature-item__delete{display:block;width:30px;height:30px;background:#fff;border:none;background-image:url(" + escape(__webpack_require__(53)) + ");background-position:50%;background-repeat:no-repeat\n}", "", {"version":3,"sources":["/Users/romanprivlov/Desktop/Projects/nnz-sale-scraping/src/css/variables.css","/Users/romanprivlov/Desktop/Projects/nnz-sale-scraping/src/vue-comp/interface/src/vue-comp/interface/feature-list-item.vue"],"names":[],"mappings":";AAEA,MAQI,gCAAqC;CACxC;ACiCD,cACA,aAAA,8BACA,iBACA,UACA,gBACA,0CAEA,YACA;CACA;AAEA,+BACA,gBAAA,qCAEA;CACA;AAEA,oBACA,UAAA,YACA,kCACA;CACA;AAEA,sBACA,cAAA,WACA,YACA,gBACA,YACA,+CACA,wBACA,2BACA;CACA","file":"feature-list-item.vue","sourcesContent":["@import \"http://fonts.fontstorage.com/import/opensans.css\";\n\n:root {\n    --marine: #008F9F;\n    --green: #00A287;\n    --light-grey: #f6f6f9;\n    --column: calc(100vw / 24);\n    --row: calc(100vh / 12);\n    --column-mobile: calc(100vw / 12);\n    --row-mobile: calc(100vh / 24);\n    font-family: 'Open Sans', sans-serif;\n}\n","<template lang=\"html\">\n\n    <div class=\"feature-item\" :id=\"featureId\">\n        <input\n            type=\"text\"\n            name=\"feature\"\n            class=\"feature-item__name\"\n            :value=\"name\"\n            :readonly=\"!isEditable\"\n        >\n        <button v-if=\"isEditable\" class=\"feature-item__delete\" @click=\"deleteHandler\"></button>\n    </div>\n\n</template>\n\n<script>\nexport default {\n\n    props: ['iseditable', 'description', 'featureid', 'edit'],\n\n    data() {\n        return {\n            isEditable: this.iseditable,\n            name: this.description,\n            featureId: this.featureid,\n            currentEdit: this.edit\n        }\n    },\n\n    methods: {\n        //Удаляем запись\n        deleteHandler() {\n            this.$emit('delete-feature', this.featureId);\n        }\n    }\n\n\n}\n</script>\n\n<style lang=\"css\">\n\n    @import './../../css/variables.css';\n\n    .feature-item {\n        display: flex;\n        justify-content: space-between;\n        margin: 20px auto;\n        width: 90%;\n        min-height: 50px;\n        -webkit-box-shadow: 1px 4px 6px rgba(0,143,159,.4);\n        box-shadow: 1px 4px 6px rgba(0,143,159,.4);\n        padding: 10px;\n    }\n\n    .draggable-mirror.feature-item {\n        max-width: 400px;\n        -webkit-box-shadow: 0px 0px 6px rgba(0,143,159,.8);\n        box-shadow: 0px 0px 6px rgba(0,143,159,.8);\n    }\n\n    .feature-item__name {\n        width: 70%;\n        border: none;\n        background-color: rgba(255,255,255,0);\n    }\n\n    .feature-item__delete {\n        display: block;\n        width: 30px;\n        height: 30px;\n        background: #fff;\n        border: none;\n        background-image: url('./../../img/delete.svg');\n        background-position: center;\n        background-repeat: no-repeat;\n    }\n\n</style>\n"],"sourceRoot":""}]);
...
module.exports = "img/../img/delete.svg";
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "feature-item", attrs: { id: _vm.featureId } },
    [
      _c("input", {
        staticClass: "feature-item__name",
        attrs: { type: "text", name: "feature", readonly: !_vm.isEditable },
        domProps: { value: _vm.name }
      }),
      _vm._v(" "),
      _vm.isEditable
        ? _c("button", {
            staticClass: "feature-item__delete",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-001c1d35", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5c1be7dc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_vue__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5c1be7dc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5c1be7dc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/vue-comp/interface/schema-aside.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c1be7dc", Component.options)
  } else {
    hotAPI.reload("data-v-5c1be7dc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("c18dbd32", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c1be7dc\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema-aside.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c1be7dc\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema-aside.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_schema_aside_item_vue__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_24a9721e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_item_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_24a9721e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_item_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_24a9721e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_schema_aside_item_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24a9721e", Component.options)
  } else {
    hotAPI.reload("data-v-24a9721e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("20d906bc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24a9721e\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema-aside-item.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24a9721e\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./schema-aside-item.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-24a9721e", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5c1be7dc", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a1065cb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_indicator_vue__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_indicator_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a1065cb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_indicator_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a1065cb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_indicator_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/vue-comp/interface/loading-indicator.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a1065cb0", Component.options)
  } else {
    hotAPI.reload("data-v-a1065cb0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("5d392719", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a1065cb0\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./loading-indicator.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a1065cb0\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./loading-indicator.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n#loading-wrapper{position:fixed;width:100%;height:100%;left:0;top:0\n}\n#loading-text{display:block;position:absolute;top:50%;left:50%;color:#999;width:100px;height:30px;margin:-7px 0 0 -45px;text-align:center;font-family:PT Sans Narrow,sans-serif;font-size:20px\n}\n#loading-content{display:block;position:relative;left:50%;top:50%;width:170px;height:170px;margin:-85px 0 0 -85px;border:3px solid red\n}\n#loading-content:after{content:\"\";position:absolute;border:3px solid #0f0;left:15px;right:15px;top:15px;bottom:15px\n}\n#loading-content:before{content:\"\";position:absolute;border:3px solid #00f;left:5px;right:5px;top:5px;bottom:5px\n}\n#loading-content{border:3px solid transparent;border-top-color:#4d658d;border-bottom-color:#4d658d;border-radius:50%;animation:a 2s linear infinite\n}\n#loading-content:before{border:3px solid transparent;border-top-color:#d4cc6a;border-bottom-color:#d4cc6a;border-radius:50%;animation:a 3s linear infinite\n}\n#loading-content:after{border:3px solid transparent;border-top-color:#84417c;border-bottom-color:#84417c;border-radius:50%;animation:a 1.5s linear infinite;-moz-animation:a 2s linear infinite;-o-animation:a 2s linear infinite\n}\n@keyframes a{\n0%{transform:rotate(0deg)\n}\nto{transform:rotate(1turn)\n}\n}", "", {"version":3,"sources":["/Users/romanprivlov/Desktop/Projects/nnz-sale-scraping/src/vue-comp/interface/src/vue-comp/interface/loading-indicator.vue"],"names":[],"mappings":";AAkBA,iBACA,eAAA,WACA,YACA,OACA,KACA;CACA;AAEA,cACA,cAAA,kBACA,QACA,SACA,WACA,YACA,YACA,sBACA,kBACA,sCACA,cACA;CACA;AAEA,iBACA,cAAA,kBACA,SACA,QACA,YACA,aACA,uBACA,oBACA;CACA;AAEA,uBACA,WAAA,kBACA,sBACA,UACA,WACA,SACA,WACA;CACA;AAEA,wBACA,WAAA,kBACA,sBACA,SACA,UACA,QACA,UACA;CACA;AAEA,iBACA,6BAAA,yBACA,4BACA,kBACA,8BAIA;CACA;AAEA,wBACA,6BAAA,yBACA,4BACA,kBACA,8BAIA;CACA;AAEA,uBACA,6BAAA,yBACA,4BACA,kBACA,iCAEA,oCACA,iCACA;CACA;AAeA;AACA,GAGA,sBAAA;CACA;AAEA,GAGA,uBAAA;CACA;CACA","file":"loading-indicator.vue","sourcesContent":["<template lang=\"html\">\n\n    <div id=\"loading-wrapper\">\n      <div id=\"loading-text\">Загрузка</div>\n      <div id=\"loading-content\"></div>\n    </div>\n\n</template>\n\n<script>\nexport default {\n}\n</script>\n\n<style lang=\"css\">\n\n\n\n    #loading-wrapper {\n        position: fixed;\n        width: 100%;\n        height: 100%;\n        left: 0;\n        top: 0;\n    }\n\n    #loading-text {\n        display: block;\n        position: absolute;\n        top: 50%;\n        left: 50%;\n        color: #999;\n        width: 100px;\n        height: 30px;\n        margin: -7px 0 0 -45px;\n        text-align: center;\n        font-family: 'PT Sans Narrow', sans-serif;\n        font-size: 20px;\n    }\n\n    #loading-content {\n        display: block;\n        position: relative;\n        left: 50%;\n        top: 50%;\n        width: 170px;\n        height: 170px;\n        margin: -85px 0 0 -85px;\n        border: 3px solid #F00;\n    }\n\n    #loading-content:after {\n        content: \"\";\n        position: absolute;\n        border: 3px solid #0F0;\n        left: 15px;\n        right: 15px;\n        top: 15px;\n        bottom: 15px;\n    }\n\n    #loading-content:before {\n        content: \"\";\n        position: absolute;\n        border: 3px solid #00F;\n        left: 5px;\n        right: 5px;\n        top: 5px;\n        bottom: 5px;\n    }\n\n    #loading-content {\n        border: 3px solid transparent;\n        border-top-color: #4D658D;\n        border-bottom-color: #4D658D;\n        border-radius: 50%;\n        -webkit-animation: loader 2s linear infinite;\n        -moz-animation: loader 2s linear infinite;\n        -o-animation: loader 2s linear infinite;\n        animation: loader 2s linear infinite;\n    }\n\n    #loading-content:before {\n        border: 3px solid transparent;\n        border-top-color: #D4CC6A;\n        border-bottom-color: #D4CC6A;\n        border-radius: 50%;\n        -webkit-animation: loader 3s linear infinite;\n        -moz-animation: loader 2s linear infinite;\n        -o-animation: loader 2s linear infinite;\n        animation: loader 3s linear infinite;\n    }\n\n    #loading-content:after {\n        border: 3px solid transparent;\n        border-top-color: #84417C;\n        border-bottom-color: #84417C;\n        border-radius: 50%;\n        -webkit-animation: loader 1.5s linear infinite;\n        animation: loader 1.5s linear infinite;\n        -moz-animation: loader 2s linear infinite;\n        -o-animation: loader 2s linear infinite;\n    }\n\n    @-webkit-keyframes loaders {\n        0% {\n            -webkit-transform: rotate(0deg);\n            -ms-transform: rotate(0deg);\n            transform: rotate(0deg);\n        }\n        100% {\n            -webkit-transform: rotate(360deg);\n            -ms-transform: rotate(360deg);\n            transform: rotate(360deg);\n        }\n    }\n\n    @keyframes loader {\n        0% {\n            -webkit-transform: rotate(0deg);\n            -ms-transform: rotate(0deg);\n            transform: rotate(0deg);\n        }\n\n        100% {\n            -webkit-transform: rotate(360deg);\n            -ms-transform: rotate(360deg);\n            transform: rotate(360deg);\n        }\n    }\n\n\n\n</style>\n"],"sourceRoot":""}]);
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { attrs: { id: "loading-wrapper" } }, [
      _c("div", { attrs: { id: "loading-text" } }, [_vm._v("Загрузка")]),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a1065cb0", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f07f114_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_flash_message_vue__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flash_message_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f07f114_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_flash_message_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f07f114_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_flash_message_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/vue-comp/interface/flash-message.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f07f114", Component.options)
  } else {
    hotAPI.reload("data-v-6f07f114", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// add the styles to the DOM
var add = __webpack_require__(1).default
var update = add("448fc5b4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6f07f114\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./flash-message.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6f07f114\",\"scoped\":false,\"sourceMap\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./flash-message.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.flashMessage{position:fixed;top:40px;right:40px;padding:20px;width:30%;background-image:linear-gradient(180deg,#203756,#465e7e);box-shadow:1px 1px 4px rgba(0,0,0,.3);transform-origin:center;transition:all .3s ease-in-out\n}\n.flashMessage__text{text-align:center;color:#fff\n}\n.flashMessage_inactive{visibility:hidden;opacity:0;transform:scale(0);transform-origin:center\n}\n.flashMessage_active{visibility:visible;opacity:1;transform:scale(1);transform-origin:center\n}", "", {"version":3,"sources":["/Users/romanprivlov/Desktop/Projects/nnz-sale-scraping/src/vue-comp/interface/src/vue-comp/interface/flash-message.vue"],"names":[],"mappings":";AAmCA,cACA,eAAA,SACA,WACA,aACA,UACA,yDACA,sCAEA,wBACA,8BAGA;CAEA;AAEA,oBACA,kBAAA,UACA;CACA;AAEA,uBACA,kBAAA,UACA,mBACA,uBACA;CACA;AAEA,qBACA,mBAAA,UACA,mBACA,uBACA;CACA","file":"flash-message.vue","sourcesContent":["<template lang=\"html\">\n\n    <div :class=\"flashMessage\">\n        <p class=\"flashMessage__text\">{{text}}</p>\n    </div>\n\n</template>\n\n<script>\nexport default {\n\n    props: ['message'],\n\n    computed: {\n\n        text() {\n            return this.message;\n        },\n\n        //Показываем сообщение, если в компонент посупил текс\n        flashMessage() {\n            return {\n                'flashMessage' : true,\n                'flashMessage_inactive': this.text.length === 0,\n                'flashMessage_active': this.text.length > 0\n            }\n        }\n    }\n\n}\n</script>\n\n<style lang=\"css\">\n\n\n    .flashMessage {\n        position: fixed;\n        top: 40px;\n        right: 40px;\n        padding: 20px;\n        width: 30%;\n        background-image: linear-gradient(to bottom, #203756, #465E7E);\n        -webkit-box-shadow: 1px 1px 4px rgba(0,0,0,.3);\n        box-shadow: 1px 1px 4px rgba(0,0,0,.3);\n        transform-origin: center;\n        -webkit-transition: all .3s ease-in-out;\n        -o-transition: all .3s ease-in-out;\n        transition: all .3s ease-in-out;\n\n    }\n\n    .flashMessage__text {\n        text-align: center;\n        color:#fff;\n    }\n\n    .flashMessage_inactive {\n        visibility: hidden;\n        opacity: 0;\n        transform: scale(0);\n        transform-origin: center;\n    }\n\n    .flashMessage_active {\n        visibility: visible;\n        opacity: 1;\n        transform: scale(1);\n        transform-origin: center;\n    }\n\n\n\n\n\n</style>\n"],"sourceRoot":""}]);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { class: _vm.flashMessage }, [
    _c("p", { staticClass: "flashMessage__text" }, [_vm._v(_vm._s(_vm.text))])
  ])
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f07f114", { render: render, staticRenderFns: staticRenderFns })
  }
}
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "schema-create" }, [
        _c(
          "div",
          { staticClass: "schema-create-block" },
          [
            _c("h2", [_vm._v("Создание шаблона")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
              ...
              staticClass: "schema-create-block__title",
              attrs: {
                type: "text",
                name: "",
                id: "",
            ...
            _c("input", {
              ...
              staticClass: "schema-create-block__article",
              attrs: {
                type: "text",
                name: "",
                id: "",
            ...
            _c(
              "label",
              {
                staticClass: "schema-create-block__label",
                attrs: { for: "source" }
              },
              [_vm._v("Выберите источник:")]
            ),
            _vm._v(" "),
            _c(
              "select",
              {
                ...
                staticClass: "schema-create-block__select",
              ...
              _vm._l(_vm.resources, function(item) {
            ...
            _vm.stage === 1
              ? _c("input", {
                  staticClass: "schema-create-block__submit",
                  attrs: { type: "submit", value: "Сгенерировать" },
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      _vm.generateSchemaHanler($event)
                    }
                  }
                })
              : _vm._e(),
            _vm._v(" "),
            _vm.stage === 2 ? _c("loading") : _vm._e(),
            _vm._v(" "),
            _c("div", { staticClass: "schema-create-features" }, [
              _c(
                "div",
                { staticClass: "schema-create-features-nnz" },
                [
                  _vm.nnzFeatures.length > 0
                    ? [
                        _vm._l(_vm.nnzFeatures, function(item, index) {
                          return _c("feature", {
                            key: item.id,
                            attrs: {
                              iseditable: true,
                            ...
                            on: { "delete-feature": _vm.deleteFeatureHandler }
                          })
                        }),
                        _vm._v(" "),
                        _c("button", {
                          staticClass: "feature-add",
                          attrs: { type: "button", name: "button" },
                          on: { click: _vm.addFeatureHandler }
                        })
                      ]
                    : _vm._e()
                ],
              ...
              _c(
                "div",
                { staticClass: "schema-create-features-site" },
                [
                  _vm.siteFeatures.length > 0
                    ? _vm._l(_vm.siteFeatures, function(item, index) {
                        return _c("feature", {
                          key: item.id,
                          attrs: {
                            iseditable: false,
            ...
            _vm.stage === 3
              ? _c(
                  "button",
                  {
                    staticClass: "schema-create-block__submit",
                    attrs: { type: "button", name: "button" },
                    on: { click: _vm.saveSchemaHandler }
                  },
                  [_vm._v("Сохранить")]
                )
              : _vm._e()
      ...
      _vm._v(" "),
      _c("flash-message", { attrs: { message: _vm.flashMsg } })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1ff23f11", { render: render, staticRenderFns: staticRenderFns })
  }
}
